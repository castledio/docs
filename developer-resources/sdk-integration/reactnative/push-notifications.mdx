...
<Tabs>
    ...
    We recommend configuring the [appgroupId](/developer-resources/sdk-integration/ios/push-notifications#3-adding-an-app-group-id) and using the [Notification Service Extension](/developer-resources/sdk-integration/ios/rich-push-notification) for enhanced tracking of notification impressions, accurate badge counts, and media support.
