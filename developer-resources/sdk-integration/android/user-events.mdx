...
Each event can be accompanied by relevant additional parameters. For instance, the `added_to_cart` event can include parameters
...
<Note>
 Try out [here](/developer-resources/sdk-integration/api/track-an-event)
 </Note>
