...
1. First, copy the AAR package of the **MiPush** SDK, `MiPush_SDK_Client_5_1_1-G_3rd.aar`, to the project `/libs/` directory, and then to the `build.gradle` of the project app module dependency.
