...
Starting from Castled iOS version `4.0.0`, AppInbox functionality is separated as a new module `CastledInbox`. Add the module pod as dependency in the app pod file.
...
Embed `AppInboxViewController` within your existing navigation flow for a consistent user experience.
    ...
    <CodeGroup>
      ...
      - (void)pushViewController {
          UIViewController *inboxViewController = [[Castled sharedInstance] getInboxViewControllerWithUIConfigs:nil andDelegate:self];
