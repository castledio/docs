...
### Using APNS Authentication Key

![](/images/ios-1.png)
This [doc](/developer-resources/sdk-integration/ios/configuring-p8) has more information on how to obtain **.p8 file**.

### Using APNS Provider Certificate

![](/images/ios-2.png)
This [doc](/developer-resources/sdk-integration/ios/configuring-p12) has more information on how to obtain **.p12 certificate**.
