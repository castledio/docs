...
<Note>
Ensure the **appGroupId** mentioned above matches the App Group ID in the Signing & Capabilities tab for all relevant targets, including extensions. If you haven’t enabled App Groups, there is no need to set appGroupId.

We recommend using the [Notification Service Extension](/developer-resources/sdk-integration/ios/rich-push-notification) for better tracking of notification impressions, accurate badge counts, and media support.
