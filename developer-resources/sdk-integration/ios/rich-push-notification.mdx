...
1. Add the CastledNotificationContent.framework to your Xcode project.
2. Go to your Notification Content Extension target's Build Phases.
3. Expand the "Link Binary With Libraries" section.
4. Click the "+" button and add the CastledNotificationContent.framework.
![](/images/NCE-4.png)
5. Import the framework in your Notification Content Extension code file
![](/images/NCE-5.png)
