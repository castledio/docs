---
title: "Creating Push Campaign"
---

## Creating Campaign

Creating a push campaign is similar to any [other campaign](/engagement/campaign/generic-create-campaign). Only difference is to select **Push** as the channel type.
