...
The Basic Message is a text-based notification, primarily consisting of a title and a description. It's the simplest form of message and is typically used for straightforward communications.
