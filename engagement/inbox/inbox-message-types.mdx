...
This is similar to the Basic Message but includes an icon to visually represent the content or source of the message. Icons can aid in quickly identifying the message type or category.
...
The Message with Media integrates visual elements like images or videos alongside a title and description. This combination of rich media with concise text allows for a vibrant yet informative user experience.
