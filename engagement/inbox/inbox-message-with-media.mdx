...
The Basic Message without Icon is a simple, text-based notification designed to deliver concise information without the inclusion of visual icons. Details for capturing the details can be found [here](/engagement/inbox/inbox-message-with-media)
...
**Image Orientation:** Specify the preferred orientation for your image. Options include Landscape, Portrait, or Square.

**Image URL:** Provide the URL of the media (image) you intend to incorporate in the message.

<Note>
Recommended Aspect Ratio:** 3:2
Max Image Size: 2Mb. Ensure your media does not exceed this size for optimal load times and user experience.
</Note>
