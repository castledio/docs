...
### 6. Enter the first name , last name and password to complete the registration process.

![](/images/custom-signup-6.png)

### 7. Upon successful registration user will be automatically logged into the application.
